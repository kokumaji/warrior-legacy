...
import me.kokumaji.Warrior.Game.Objects.Kits.Archer;
...
public class KitManager {
    ...
    public static void SetKit(WarriorUser u, Kit k) {
        if (k != null) {
            ...
            String formatted = InternalMessages.format(InternalMessages.KIT_NOT_FOUND,
                    u.getUsername());

            Warrior.getPluginLogger().warn(formatted);
        }
    }
