...
public class LobbyManager {
    ...
    private void SetInventory(Player player) {
        ...
        ItemMeta languageMeta = languageSelector.getItemMeta();

        languageMeta.setDisplayName("§e§lChange Language §r» §8(right click)");
        languageSelector.setItemMeta(languageMeta);
        ...
        player.getInventory().setItem(7, languageSelector);
